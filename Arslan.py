...
\033[1;93m=°=°=> ########  #######  ########  #### <=°=°=
-----------------------------------------------
 PROGRAMER   : ZUBAIR ZUBI
 FACEBOOK    : USMAN ULLAH
 WHATSAPP    : MAI NAHI BATAONGA
 LOVE YOU BHAI LOG AUR UNKY BEHN LOG
-----------------------------------------------"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/ABDullaahMustafa/Arsslan/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923159385839')
        reg()
...
def hop():
	...
	if hack =="":
		...
		super()
	        ...
	        os.system('xdg-open https://www.facebook.com/zubi.hacker.007')
	        menu()
